...
LINKEDIN_JOB_SEARCH_INPUT = "senior automation test in india" #'SDET in india'  ##
...
question_answer_map = {
    ...
    "How many years of work experience do you have with Pega Customer Service?":'0',
    ...
    "What tools used for API testing?": 'Postman, requests',
    ...
    "What is your availability?": "Immediately Available",
    "Are you currently living in or ready to relocate to Hyderabad/Secunderabad ?":'yes',
    ...
    "Skills (Enter Comma Separated Values for e.g., Java,BigData,HTML )":'Python, UI Automation, API Automation, Postman',
    "Which tool of performance testing have you used...please explain": 'Jmeter',
    ...
    "Post Applying For":"SDET - QA (Manual & Automation)",
    ...
    "Mention any other skill ( If you have any )":'NA',
    ...
    "Title of your most recent job role":'Automation test engineer',
    "What is your Current CTC ?":CURRENT_CTC_NUMERIC,
    ...
    "Languages (Enter Comma Separated Values for e.g., English,Hindi,Tamil)":"English,Hindi, Marathi",
    ...
    "Choose the BEST will describe your EXPERTISE in PYTHON?":"Automation",
