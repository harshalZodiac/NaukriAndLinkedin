...
question_answer_map = {
    ...
    "What are your annual salary expectations?": EXPECTED_CTC,
    ...
    "How soon are you available to join (in days)?": NOTICE_PERIOD,
    "How many days are left for your notice period?": NOTICE_PERIOD,
    "What is your Current CTC?": CURRENT_CTC,
    "How soon you can join us?": NOTICE_PERIOD,
    "What are your salary expectations? (INR)": EXPECTED_CTC,
    ...
    "What is your current CTC per annaum ?": CURRENT_CTC,
    ...
    "What is your Expected Salary per annum?": EXPECTED_CTC,
    ...
    "If offered the role, within how many days will you be able to join?": NOTICE_PERIOD,
    ...
    "What is your expected salary?":EXPECTED_CTC,
    "How many years of Software Testing experience do you currently have?":YEARS_OF_EXPERIENCE_IN_CORE,
    "How many years of work experience do you have with IRD?":EXPECTED_CTC,
    "What is your notice period (in days)?":NOTICE_PERIOD_IN_DAYS,
    "Please Tell us your Current CTC":CURRENT_CTC,
    "Notice Period?":NOTICE_PERIOD,
    ...
    "What is your Expected Annual Salary ?":EXPECTED_CTC,
